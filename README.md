...
|정이진트리|완전이진트리|균형이진트리|
|---|---|---|
|<img src="./image/BinaryTree1.png" width="40%" height="30%" title="정이진" ></img>|<img src="./image/BinaryTree2.png" width="40%" height="30%" title="완전" ></img>|<img src="./image/BinaryTree3.png" width="40%" height="30%" title="균형이진" ></img>|


# 일반트리 -> 이진트리 변환

<img src="./image/TreeTransformation.png" width="40%" height="30%" title="일반트리 -> 이진트리 변환" ></img>
...
<img src="./image/Heap.png" width="40%" height="30%" title="일반트리 -> 이진트리 변환" ></img>
...
<img src="./image/BinarySearchTree.png" width="40%" height="30%" title="이진탐색트리" ></img>

+ 이진탐색트리를 순회할땐 중위순회방식을 사용한다(좌 – 상 - 우)

※ [정렬](https://gmlwjd9405.github.io/2018/05/10/algorithm-heap-sort.html) ※

<img src="./image/TimeComplexity.png" width="40%" height="30%" title="정렬 알고리즘 시간복잡도" ></img>
...
<img src="./image/DFSvsBFS.png" width="40%" height="30%" title="DFS vs BFS" ></img>
